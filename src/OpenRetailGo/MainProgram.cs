...
using OpenRetailGo.Main;
using OpenRetailGo.Helper;
using OpenRetailGo.Lookup;

[assembly: log4net.Config.XmlConfigurator(Watch = true)]
namespace OpenRetailGo
{
    static class MainProgram
    {
        ...
        /// <summary>
        /// Url informasi update terbaru, untuk petunjuknya cek: https://github.com/initprog/OpenRetailGo/releases
        /// </summary>
        public static readonly string onlineUpdateUrlInfo = "https://raw.githubusercontent.com/initprog/OpenRetailGo/master/updater/openretailgo-autoupdater.xml";

        public static readonly string stageOfDevelopment = "";
        public static readonly string appName = "OpenRetailGo";
