...
namespace OpenRetailGo.Main
{
    public partial class FrmAbout : Form
    {
        ...
        private void ShowInfoAbout()
        {
            ...
            lblCopyright.Text = "OpenRetailGo is made possible by\n   Kamarudin's OpenRetailer and other open source software.";
            lblContent.Text = @"OpenRetailGo membantu pengusaha ritel dengan fasilitas POS (Point Of Sale), melacak produk and inventaris, transaksi jual-beli, hutang-piutang, gaji pegawai, dan laporan.";
         }
