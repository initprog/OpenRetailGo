...
using OpenRetailGo.Referensi;
using OpenRetailGo.Transaksi;
using OpenRetailGo.Pengeluaran;
using OpenRetailGo.Laporan;
using OpenRetailGo.Pengaturan;
...
namespace OpenRetailGo.Main
{
    public partial class FrmMain : Form, IListener
    {
        ...
        public void InitializeStatusBar()
        {
            ...
            sbTanggal.Text = string.Format("{0}, {1}", DayMonthHelper.GetHariIndonesia(dt), dt.Day + " " + DayMonthHelper.GetBulanIndonesia(dt.Month, true) + " " + dt.Year);
            ...
            this.Text = MainProgram.appName;
            sbNamaAplikasi.Text = String.Empty;
        }
        ...
        private void mnuPetunjukPenggunaan_Click(object sender, EventArgs e)
        {
            var url = "https://github.com/initprog/OpenRetailGo/wiki/";
            OpenUrl(url);
        }

        private void mnuRegistrasi_Click(object sender, EventArgs e)
        {
            var url = "https://github.com/initprog/OpenRetailGo/wiki/registrasi/";
            OpenUrl(url);
        }        
