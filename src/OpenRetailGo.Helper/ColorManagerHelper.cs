 ...
 * Modified work copyright OpenRetailGo
 *
...
using OpenRetailGo.Helper.UserControl;

namespace OpenRetailGo.Helper
{
    /// <summary>
    /// Enum ini sesuai dengan urutan <colorManager> di App.config
    /// </summary>
    public enum ColorSection
    {
        FormBackColor = 1, 
        PanelHeaderBackColor = 2,
        PanelFooterBackColor = 3, 
        LabelHeaderForeColor = 4,
        TextFocusColor = 5
    }
                ...
                switch (ctlType)
                {
                    ...
                    case "Label":
                        ...
                        if (objLabel.Name == "lblHeader")
                        {
                            ...
                            objLabel.Font = new Font("Segoe UI", 10, FontStyle.Bold);
                        }
