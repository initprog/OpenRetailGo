...
using OpenRetailGo.Cashier.Transaksi;
using OpenRetailGo.Model;
using OpenRetailGo.Bll.Api;
using OpenRetailGo.Bll.Service;
using log4net;
using AutoUpdaterDotNET;
using OpenRetailGo.Cashier.Pengaturan;
using OpenRetailGo.Cashier.Laporan;
        ...
        private void AutoUpdaterOnCheckForUpdateEvent(UpdateInfoEventArgs args)
        {
            if (args.Error == null)
            {
                ...
                {                    
                    ...
                    var currentVersion = string.Format("{0}", args.CurrentVersion);
